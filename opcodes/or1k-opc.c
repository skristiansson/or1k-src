...
static const CGEN_IFMT ifmt_l_maci ATTRIBUTE_UNUSED = {
  32, 32, 0xfc1f0000, { { F (F_OPCODE) }, { F (F_RESV_20_5) }, { F (F_R2) }, { F (F_SIMM16) }, { 0 } }
};
