...
static const CGEN_OPINST sfmt_l_jal_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "disp26", HW_H_IADDR, CGEN_MODE_UDI, OP_ENT (DISP26), 0, 0 },
  { INPUT, "h_delay_pc_UDI", HW_H_DELAY_PC, CGEN_MODE_UDI, 0, 0, 0 },
  { OUTPUT, "h_gr_UDI_9", HW_H_GR, CGEN_MODE_UDI, 0, 9, 0 },
  { OUTPUT, "pc", HW_H_PC, CGEN_MODE_UDI, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};

static const CGEN_OPINST sfmt_l_jr_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { OUTPUT, "pc", HW_H_PC, CGEN_MODE_UDI, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_bnf_ops[] ATTRIBUTE_UNUSED = {
  ...
  { INPUT, "sys_sr_f", HW_H_SYS_SR_F, CGEN_MODE_UINT, 0, 0, 0 },
...
static const CGEN_OPINST sfmt_l_movhi_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "uimm16", HW_H_UIMM16, CGEN_MODE_UINT, OP_ENT (UIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_mfspr_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_spr_UDI_or__UDI_rA_uimm16", HW_H_SPR, CGEN_MODE_UDI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "uimm16", HW_H_UIMM16, CGEN_MODE_UINT, OP_ENT (UIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_mtspr_ops[] ATTRIBUTE_UNUSED = {
  ...
  { OUTPUT, "h_spr_UDI_or__UDI_rA_uimm16_split", HW_H_SPR, CGEN_MODE_UDI, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};

static const CGEN_OPINST sfmt_l_lwz_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_memory_USI_add__UDI_rA_simm16", HW_H_MEMORY, CGEN_MODE_USI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
...
static const CGEN_OPINST sfmt_l_lws_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_memory_SI_add__UDI_rA_simm16", HW_H_MEMORY, CGEN_MODE_SI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "simm16", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
...
static const CGEN_OPINST sfmt_l_lbz_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_memory_UQI_add__UDI_rA_simm16", HW_H_MEMORY, CGEN_MODE_UQI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "simm16", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
...
static const CGEN_OPINST sfmt_l_lbs_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_memory_QI_add__UDI_rA_simm16", HW_H_MEMORY, CGEN_MODE_QI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "simm16", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
...
static const CGEN_OPINST sfmt_l_lhz_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_memory_UHI_add__UDI_rA_simm16", HW_H_MEMORY, CGEN_MODE_UHI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "simm16", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
...
static const CGEN_OPINST sfmt_l_lhs_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "h_memory_HI_add__UDI_rA_simm16", HW_H_MEMORY, CGEN_MODE_HI, 0, 0, 0 },
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "simm16", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
...
static const CGEN_OPINST sfmt_l_sw_ops[] ATTRIBUTE_UNUSED = {
  ...
  { OUTPUT, "h_memory_USI_add__AI_rA_simm16_split", HW_H_MEMORY, CGEN_MODE_USI, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_sb_ops[] ATTRIBUTE_UNUSED = {
  ...
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { INPUT, "simm16_split", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16_SPLIT), 0, 0 },
  { OUTPUT, "h_memory_UQI_add__AI_rA_simm16_split", HW_H_MEMORY, CGEN_MODE_UQI, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_sh_ops[] ATTRIBUTE_UNUSED = {
  ...
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { INPUT, "simm16_split", HW_H_SIMM16, CGEN_MODE_INT, OP_ENT (SIMM16_SPLIT), 0, 0 },
  { OUTPUT, "h_memory_UHI_add__AI_rA_simm16_split", HW_H_MEMORY, CGEN_MODE_UHI, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_add_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { INPUT, "sys_sr_ov", HW_H_SYS_SR_OV, CGEN_MODE_UINT, 0, 0, 0 },
  { INPUT, "sys_sr_ove", HW_H_SYS_SR_OVE, CGEN_MODE_UINT, 0, 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { OUTPUT, "sys_sr_cy", HW_H_SYS_SR_CY, CGEN_MODE_UINT, 0, 0, 0 },
  { OUTPUT, "sys_sr_ov", HW_H_SYS_SR_OV, CGEN_MODE_UINT, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_addc_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { INPUT, "sys_sr_cy", HW_H_SYS_SR_CY, CGEN_MODE_UINT, 0, 0, 0 },
  { INPUT, "sys_sr_ov", HW_H_SYS_SR_OV, CGEN_MODE_UINT, 0, 0, 0 },
  { INPUT, "sys_sr_ove", HW_H_SYS_SR_OVE, CGEN_MODE_UINT, 0, 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { OUTPUT, "sys_sr_cy", HW_H_SYS_SR_CY, CGEN_MODE_UINT, 0, 0, 0 },
...
static const CGEN_OPINST sfmt_l_div_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, COND_REF },
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { INPUT, "sys_sr_cy", HW_H_SYS_SR_CY, CGEN_MODE_UINT, 0, 0, 0 },
  { INPUT, "sys_sr_ove", HW_H_SYS_SR_OVE, CGEN_MODE_UINT, 0, 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, COND_REF },
  { OUTPUT, "sys_sr_cy", HW_H_SYS_SR_CY, CGEN_MODE_UINT, 0, 0, COND_REF },
  { OUTPUT, "sys_sr_ov", HW_H_SYS_SR_OV, CGEN_MODE_UINT, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_andi_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "uimm16", HW_H_UIMM16, CGEN_MODE_UINT, OP_ENT (UIMM16), 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
...
static const CGEN_OPINST sfmt_l_cmov_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, COND_REF },
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, COND_REF },
  { INPUT, "sys_sr_f", HW_H_SYS_SR_F, CGEN_MODE_UINT, 0, 0, 0 },
  { OUTPUT, "rD", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RD), 0, COND_REF },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_l_sfgtu_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "rB", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RB), 0, 0 },
  { OUTPUT, "sys_sr_f", HW_H_SYS_SR_F, CGEN_MODE_UINT, 0, 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
...
static const CGEN_OPINST sfmt_lf_itof_s_ops[] ATTRIBUTE_UNUSED = {
  { INPUT, "rA", HW_H_GR, CGEN_MODE_UDI, OP_ENT (RA), 0, 0 },
  { INPUT, "sys_fpcsr_rm", HW_H_SYS_FPCSR_RM, CGEN_MODE_UINT, 0, 0, 0 },
  { OUTPUT, "rDSF", HW_H_FSR, CGEN_MODE_SF, OP_ENT (RDSF), 0, 0 },
  { END, (const char *)0, (enum cgen_hw_type)0, (enum cgen_mode)0, (enum cgen_operand_type)0, 0, 0 }
};
