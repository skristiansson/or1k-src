...
typedef enum spr_reg_indices {
 ...
 , SPR_INDEX_SYS_GPR511 = 1535, SPR_INDEX_MAC_MACLO = 1, SPR_INDEX_MAC_MACHI = 2
} SPR_REG_INDICES;
...
typedef enum cgen_hw_type {
 ...
 , HW_H_MAC_MACHI, HW_H_SYS_VR_REV, HW_H_SYS_VR_CFG, HW_H_SYS_VR_VER
...
typedef enum cgen_insn_attr {
 ...
 , CGEN_INSN_NO_DIS, CGEN_INSN_PBB, CGEN_INSN_NOT_IN_DELAY_SLOT, CGEN_INSN_DELAYED_CTI
