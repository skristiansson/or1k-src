...
const CGEN_HW_ENTRY or1k_cgen_hw_table[] =
{
  ...
  { "h-pc", HW_H_PC, CGEN_ASM_NONE, 0, { 0|A(PC), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-gr", HW_H_GR, CGEN_ASM_KEYWORD, (PTR) & or1k_cgen_opval_h_gr, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-fsr", HW_H_FSR, CGEN_ASM_KEYWORD, (PTR) & or1k_cgen_opval_h_fsr, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-fdr", HW_H_FDR, CGEN_ASM_KEYWORD, (PTR) & or1k_cgen_opval_h_fdr, { 0|A(VIRTUAL), { { { (1<<MACH_OR64), 0 } } } } },
  { "h-spr", HW_H_SPR, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-sr", HW_H_SYS_SR, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-esr0", HW_H_SYS_ESR0, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-epcr0", HW_H_SYS_EPCR0, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-mac-maclo", HW_H_MAC_MACLO, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-mac-machi", HW_H_MAC_MACHI, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-sr-f", HW_H_SYS_SR_F, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-sr-cy", HW_H_SYS_SR_CY, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-sr-ov", HW_H_SYS_SR_OV, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-sr-ove", HW_H_SYS_SR_OVE, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-sys-fpcsr-rm", HW_H_SYS_FPCSR_RM, CGEN_ASM_NONE, 0, { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
  { "h-delay-pc", HW_H_DELAY_PC, CGEN_ASM_NONE, 0, { 0, { { { (1<<MACH_BASE), 0 } } } } },
  { "h-simm16", HW_H_SIMM16, CGEN_ASM_NONE, 0, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } } },
...
const CGEN_IFLD or1k_cgen_ifld_table[] =
{
  ...
  { OR1K_F_OPCODE, "f-opcode", 0, 32, 31, 6, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_R1, "f-r1", 0, 32, 25, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_R2, "f-r2", 0, 32, 20, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_R3, "f-r3", 0, 32, 15, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_25_2, "f-op-25-2", 0, 32, 25, 2, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_25_5, "f-op-25-5", 0, 32, 25, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_16_1, "f-op-16-1", 0, 32, 16, 1, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_7_4, "f-op-7-4", 0, 32, 7, 4, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_3_4, "f-op-3-4", 0, 32, 3, 4, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_9_2, "f-op-9-2", 0, 32, 9, 2, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_9_4, "f-op-9-4", 0, 32, 9, 4, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_7_8, "f-op-7-8", 0, 32, 7, 8, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_OP_7_2, "f-op-7-2", 0, 32, 7, 2, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_25_26, "f-resv-25-26", 0, 32, 25, 26, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_25_10, "f-resv-25-10", 0, 32, 25, 10, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_23_8, "f-resv-23-8", 0, 32, 23, 8, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_20_5, "f-resv-20-5", 0, 32, 20, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_20_4, "f-resv-20-4", 0, 32, 20, 4, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_15_8, "f-resv-15-8", 0, 32, 15, 8, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_15_6, "f-resv-15-6", 0, 32, 15, 6, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_10_11, "f-resv-10-11", 0, 32, 10, 11, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_10_7, "f-resv-10-7", 0, 32, 10, 7, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_10_3, "f-resv-10-3", 0, 32, 10, 3, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_10_1, "f-resv-10-1", 0, 32, 10, 1, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_7_4, "f-resv-7-4", 0, 32, 7, 4, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_RESV_5_2, "f-resv-5-2", 0, 32, 5, 2, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_IMM16_25_5, "f-imm16-25-5", 0, 32, 25, 5, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_IMM16_10_11, "f-imm16-10-11", 0, 32, 10, 11, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_DISP26, "f-disp26", 0, 32, 25, 26, { 0|A(PCREL_ADDR), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_UIMM16, "f-uimm16", 0, 32, 15, 16, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_SIMM16, "f-simm16", 0, 32, 15, 16, { 0|A(SIGN_OPT), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_UIMM6, "f-uimm6", 0, 32, 5, 6, { 0, { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_UIMM16_SPLIT, "f-uimm16-split", 0, 0, 0, 0,{ 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
  { OR1K_F_SIMM16_SPLIT, "f-simm16-split", 0, 0, 0, 0,{ 0|A(SIGN_OPT)|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
...
/* sys-sr: supervision register */
  { "sys-sr", OR1K_OPERAND_SYS_SR, HW_H_SYS_SR, 0, 0,
    { 0, { (const PTR) 0 } }, 
    { 0|A(SEM_ONLY), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
...
/* simm16: 16-bit signed immediate */
  { "simm16", OR1K_OPERAND_SIMM16, HW_H_SIMM16, 15, 16,
    ...
    { 0|A(SIGN_OPT), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
...
/* simm16-split: split 16-bit signed immediate */
  { "simm16-split", OR1K_OPERAND_SIMM16_SPLIT, HW_H_SIMM16, 10, 16,
    ...
    { 0|A(SIGN_OPT)|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
/* uimm16-split: split 16-bit unsigned immediate */
  { "uimm16-split", OR1K_OPERAND_UIMM16_SPLIT, HW_H_UIMM16, 10, 16,
    ...
    { 0|A(VIRTUAL), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }  },
...
/* l.j ${disp26} */
  {
    ...
    { 0|A(NOT_IN_DELAY_SLOT)|A(UNCOND_CTI)|A(DELAY_SLOT), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }
  },
/* l.jal ${disp26} */
  {
...
/* l.bnf ${disp26} */
  {
    ...
    { 0|A(NOT_IN_DELAY_SLOT)|A(COND_CTI)|A(DELAY_SLOT), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }
  },
/* l.bf ${disp26} */
  {
...
/* l.sys ${uimm16} */
  {
    ...
    { 0|A(NOT_IN_DELAY_SLOT), { { { (1<<MACH_OR32)|(1<<MACH_OR64), 0 } } } }
  },
/* l.rfe */
  {
